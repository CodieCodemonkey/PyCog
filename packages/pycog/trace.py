...
def trace(cls):
    ...
    if hasattr(cls, 'on_suspend_state'):
        ...
        def on_suspend_state(self, s_name):
            """on_suspend_state trace wrapper."""
